function reloj() {
    ...
    document.getElementById('minutos').style.transform = "rotate("+ porcentajeHoras +"deg)";
    document.getElementById('segundos').style.transform = "rotate("+ porcentajeHoras +"deg)";
    document.getElementById('h4-content').innerHTML = "Hora actual";
